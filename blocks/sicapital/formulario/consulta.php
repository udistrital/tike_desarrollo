...
class consulta {
    ...
    function miForm() {
        ...
        $esteCampo = "marcoSicapital";
        $atributos ['id'] = $esteCampo;
        $atributos ["estilo"] = "jqueryui";
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] =  $this->lenguaje->getCadena ( $esteCampo )." - Módulo ".$_REQUEST['modulo'];
        echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
        {
            ?><br><br><br><br><br><br><br>
            <div style='width:100%; height: 500px'>
                <iframe src="<?php echo $ruta;?>" style="width: 100%; height: 100%"></iframe>
             </div>
            <?php
